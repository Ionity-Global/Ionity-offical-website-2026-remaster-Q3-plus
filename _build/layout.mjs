...
<!-- Icons / PWA -->
<link rel="icon" href="assets/img/favicon.ico?v=27" sizes="any">
<link rel="icon" href="assets/img/favicon-64.png?v=27" type="image/png" sizes="64x64">
<link rel="icon" href="assets/img/icon-192.png?v=27" type="image/png" sizes="192x192">
<link rel="apple-touch-icon" href="assets/img/apple-touch-icon.png?v=27">
...
<link rel="stylesheet" href="assets/css/ionity.css?v=27">
...
<script src="assets/js/audio.js?v=27" defer></script>
<script src="assets/js/mario.js?v=27" defer></script>
<script src="assets/js/cookies.js?v=27" defer></script>
<script src="assets/js/core.js?v=27" defer></script>
<script src="assets/js/edge-diagnostics.js?v=27" defer></script>
<script src="assets/js/matrix-cam.js?v=27" defer></script>
<script src="assets/js/sensor-node.js?v=27" defer></script>
<script src="assets/js/disciplines-graph.js?v=27" defer></script>
<script src="assets/js/aedi-chat.js?v=27" defer></script>
<script>window.IonityGlitch=window.IonityGlitch||{};window.IonityGlitch.config={zIndex:3000};</script>
<script src="assets/js/glitch.js?v=27" defer></script>
<!-- Three.js WebGL backdrop (ES module; degrades to CSS via html.no3d) -->
<script type="module" src="assets/js/backdrop.js?v=27"></script>
</body>
</html>`;
}
