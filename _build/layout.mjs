...
<!-- Icons / PWA -->
<link rel="icon" href="assets/img/favicon.ico?v=25" sizes="any">
<link rel="icon" href="assets/img/favicon-64.png?v=25" type="image/png" sizes="64x64">
<link rel="icon" href="assets/img/icon-192.png?v=25" type="image/png" sizes="192x192">
<link rel="apple-touch-icon" href="assets/img/apple-touch-icon.png?v=25">
...
<link rel="stylesheet" href="assets/css/ionity.css?v=25">
...
<script src="assets/js/audio.js?v=25" defer></script>
<script src="assets/js/mario.js?v=25" defer></script>
<script src="assets/js/cookies.js?v=25" defer></script>
<script src="assets/js/core.js?v=25" defer></script>
<script src="assets/js/edge-diagnostics.js?v=25" defer></script>
<script src="assets/js/matrix-cam.js?v=25" defer></script>
<script src="assets/js/sensor-node.js?v=25" defer></script>
<script src="assets/js/disciplines-graph.js?v=25" defer></script>
<script src="assets/js/aedi-chat.js?v=25" defer></script>
<script>window.IonityGlitch=window.IonityGlitch||{};window.IonityGlitch.config={zIndex:3000};</script>
<script src="assets/js/glitch.js?v=25" defer></script>
<!-- Three.js WebGL backdrop (ES module; degrades to CSS via html.no3d) -->
<script type="module" src="assets/js/backdrop.js?v=25"></script>
</body>
</html>`;
}
